...
namespace eval osys::rfg {
    ...
    itcl::class Group {       
        ...
        public method group {gName closure} {
            ...
            $newGroup onEachComponent {
                incr size_int [$it size]
            }
            ## set address calculate new address 
            $newGroup address $address_int
            $newGroup size $size_int
            incr address_int $size_int            
            ## Return
            return $newGroup 
        ...
        public method register {rName closure} {
            ...
            ## calculate address
            $newRegister address $address_int
            $newRegister size 8            
            ##lappend address_list [list $address $newRegister]
            incr address_int [expr "$register_size/8"] 
            ## Return 
            ##puts $newRegister
            return $newRegister 
