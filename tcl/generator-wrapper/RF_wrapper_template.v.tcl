...
<% writeBlackbox $registerFile ""%>
    ...
    wire [<% puts -nonewline "[expr [ld [getRFsize $registerFile]]-1]" %>:3] cpu_if_address;
    wire [<% puts -nonewline "[expr [getRFmaxWidth $registerFile] -1]" %>:0] cpu_if_write_data, cpu_if_read_data;
